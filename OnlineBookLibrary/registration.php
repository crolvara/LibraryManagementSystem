...
<body>
    <div class="box">
        <table style="font-size:16pt" align="center" width="100%" height="100%">
            ...
            <tr>
                <td align="center"><b><i><mark style="color:white;background-color:green" ;>REGISTRATION PAGE</mark></i></b></td>
            </tr>
        </table>
    </div>
    <br><br>
        ...
        <fieldset align="center" style="color:blue;" class="one">
            ...
            <form action="" method="post">
                <table align="Right" style="color:white;font-size:13pt">
                    <tr>
                        <td>NAME:</td>
                        <td><input type="text" required="required" name="name1" size="17" maxlength="30"/></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="roll" required="required" size="17" maxlength="30"/></td>
                    </tr>
                    ...
                    <tr>
                        <td>E-MAIL ID:</td>
                        <td><input type="email" name="email" required="required" size="17" maxlength="30"/></td>
                    </tr>
                    <tr>
                        <td>PASSWORD:</td>
                        <td><input type="text" name="password" required="required" size="17" maxlength="30"/>
                        </td>
                    </tr>
    ...
    <div class="boxthree" style="background-color:green; border:solid 2px green;border-radius: 10px; width:73.5%; height:40px; margin-left:13%; margin-top:15px">
        <marquee behavior="alternate" direction="right" loop="1" style="margin-right:38%" align="center">
            <h6 style="line-height:1px;">For any query please <a href="aboutus.php">contact us</a>.Thank You.</h6>
        </marquee>
