  ...
  <body>
    <div class="box">
      <table style=" font-size:16pt" align="center" width="100%" height="100%">
        ...
        <tr>
          <td align="center"><b><i><mark style="color:white;background-color:green" ;>YOUR BOOKS INFORMATION</mark></i></b></td>
        </tr>
      </table>
    </div>
    ...
    <div class="nav">
        ...
        <fieldset style="height:320px; width:650px;overflow:auto" class="three">
          ...
          <table width="100%" height="310px" border="1" align="center" style="color:white;  background:rgba(0,0,0,0.38);box-shadow:0px 0px 15px lightblue;">
            ...
            if ($row[0] != "") {
              ...
              echo "</td>";
              echo "<td>";
              echo $row["recive_date_1"];
              echo "</td>";
              echo "<td>";
              echo $row["submisson_date_1"];
              echo "</td>";
              echo "</tr>";
            } else {
              echo "<tr>";
            ...
            if ($row[0] != "") {
              ...
              echo "</td>";
              echo "<td>";
              echo $row["recive_date_2"];
              echo "</td>";
              echo "<td>";
              echo $row["submisson_date_2"];
              echo "</td>";
              echo "</tr>";
            } else {
              echo "<tr>";
      ...
      <div style="background-color:green; border:solid 2px green;border-radius: 10px; width:84%; height:40px; margin-left:0%; margin-top:15px">
        <marquee>
          <p>
