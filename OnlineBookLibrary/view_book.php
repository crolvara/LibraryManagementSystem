...
<body>
  <div class="box">
    <table style=" font-size:16pt" align="center" width="100%" height="100%">
      ...
      <tr>
        <td align="center"><b><i>
              <mark style="background-color:green;color:white">VIEW BOOK PAGE</mark></i></b></td>
      </tr>
    </table>
  </div>
        ...
        <table id="table2">
          ...
          <tr>
            <td style="padding-top: 40px;padding-left: 95px">
              <input type="submit" value="Get The Book" name="rqst" style="background: green;border-radius: 2px;height: 30px;border: none;font-weight: bold;color: white">
            </td>
  ...
  <div class="boxthree" style="background-color:green; border:solid 2px green;border-radius: 10px; width:73.5%; height:40px; margin-left:13%; margin-top:15px">
    <marquee behavior="alternate" direction="right" loop="1" style="margin-right:38%" align="center">
      <h5 style="line-height:1px;">For any query please <a href="aboutus.php">contact us</a> . Thank You.</h5>
    </marquee>
