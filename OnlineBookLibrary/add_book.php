...
<body>
  <div class="box">
    <table style="border-color:green; font-size:16pt" align="center" width="100%" height="100%">
      <tr>
        <td style="color:white">
          <h1 align="center">
            <marquee>Welcome to Online Book Library</marquee>
          </h1>
        </td>
      </tr>
      <tr>
    ...
    <div class="header">
      ...
      <div class="container">
        ...
        <table style="color:#FFFFFF;padding-top:10px;">
          ...
          <tr>
            <td>
              <h2><input style="margin-left:180%;margin-top:10%;" type="submit" name="sub" value="SUBMIT" /></h2>
            </td>
          </tr>
        </table>
